...
def authenticate():
    ...
    # time.
    if os.path.exists('/home/barbieri97/Documents/projetos/python/'
                      'google-drive/authentication/token.json'):

        creds = Credentials.from_authorized_user_file(
            '/home/barbieri97/Documents/projetos/python/google-drive/'
